...
export const WORLD_PINS: MapPin[] = [
  ...
  createPin(4.711, -74.0721, { city: "Bogotá", region: "South America" }),
  ...
  createPin(52.52, 13.405, { city: "Berlin", region: "Europe" }),
  ...
  createPin(28.6139, 77.209, { city: "New Delhi", region: "Asia" }),
  ...
  createPin(-27.4705, 153.026, { city: "Brisbane", region: "Oceania" }),
