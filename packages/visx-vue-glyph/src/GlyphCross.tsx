...
import { symbol, symbolCross } from "@visx-vue/vendor/d3-shape";
...
export const GlyphCross = defineComponent({
  name: "GlyphCross",
  inheritAttrs: false,
  props: {
    ...
    return () => {
      ...
      return (
        <Glyph top={props.top} left={props.left}>
          <path class={["visx-glyph-cross", props.className]} d={path() || ""} {...attrs} />
        </Glyph>
      );
    };
  },
