...
import { symbol, symbolTriangle } from "@visx-vue/vendor/d3-shape";
...
export const GlyphTriangle = defineComponent({
  name: "GlyphTriangle",
  inheritAttrs: false,
  props: {
    ...
    return () => {
      ...
      return (
        <Glyph top={props.top} left={props.left}>
          <path class={["visx-glyph-triangle", props.className]} d={path() || ""} {...attrs} />
        </Glyph>
      );
    };
  },
