...
import { symbol, symbolDiamond } from "@visx-vue/vendor/d3-shape";
...
export const GlyphDiamond = defineComponent({
  name: "GlyphDiamond",
  inheritAttrs: false,
  props: {
    ...
    return () => {
      ...
      return (
        <Glyph top={props.top} left={props.left}>
          <path class={["visx-glyph-diamond", props.className]} d={path() || ""} {...attrs} />
        </Glyph>
      );
    };
  },
