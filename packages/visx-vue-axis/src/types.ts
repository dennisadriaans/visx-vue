import type { D3Scale, NumberLike, ScaleInput, ValueOf } from "@visx-vue/scale";
...
export type CommonProps<Scale extends AxisScale> = {
  ...
  /** Override the component used to render tick labels (instead of <Text /> from @visx-vue/text). */
  tickComponent?: (tickRendererProps: TickRendererProps) => VNode | VNode[] | null;
  /** Override the component used to render all tick lines and labels. */
  ticksComponent?: (tickRendererProps: TicksRendererProps<Scale>) => VNode | VNode[] | null;
