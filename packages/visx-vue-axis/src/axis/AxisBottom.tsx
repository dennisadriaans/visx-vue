...
export const AxisBottom = defineComponent({
  name: 'AxisBottom',
  inheritAttrs: false,
  props: {
    ...
    labelOffset: { type: Number as PropType<number>, default: 8 },
  ...
  setup(props) {
    ...
    return () => {
      ...
      const axisProps = {
        ...props,
        axisClassName: ['visx-axis-bottom', props.axisClassName].filter(Boolean).join(' '),
