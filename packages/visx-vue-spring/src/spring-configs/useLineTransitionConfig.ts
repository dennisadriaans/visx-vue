 ...
 *
 * Vue equivalent of the React `useLineTransitionConfig` hook.
 * Since the config depends only on scale/axis parameters, in Vue
 * we expose it as a plain function (or wrap in `computed` when reactive).
 */
