...
export type AnimatedGlyphSeriesProps<
...
export default defineComponent({
  ...
  setup(props) {
    ...
    function renderGlyphs(glyphsProps: GlyphsProps<AxisScale, AxisScale, object>) {
      return <AnimatedGlyphs {...glyphsProps} renderGlyph={renderGlyph} />;
    }
