...
export const LinkVerticalCurve = defineComponent({
  name: 'LinkVerticalCurve',
  inheritAttrs: false,
  props: {
  ...
  setup(props) {
    ...
    return () => {
      ...
      return (
        <path
          ref={innerRef}
          class={['visx-link visx-link-vertical-curve', props.className]}
...
export default LinkVerticalCurve
