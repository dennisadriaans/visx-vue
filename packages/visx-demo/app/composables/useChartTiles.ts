...
export const useChartTiles = () => {
  ...
  const chartTiles: ChartTileData[] = [
    ...
    },
    {
      ...
      to: "/charts/treemap",
      elements: [
        { type: "rect" as const, x: 15, y: 15, width: 200, height: 150, fill: "white", opacity: 0.7, rx: 6 },
        { type: "rect" as const, x: 225, y: 15, width: 155, height: 90, fill: "white", opacity: 0.45, rx: 6 },
        { type: "rect" as const, x: 225, y: 115, width: 155, height: 50, fill: "white", opacity: 0.25, rx: 6 },
        { type: "rect" as const, x: 15, y: 175, width: 120, height: 100, fill: "white", opacity: 0.35, rx: 6 },
        { type: "rect" as const, x: 145, y: 175, width: 235, height: 100, fill: "white", opacity: 0.18, rx: 6 },
      ],
    },
    {
      title: "Radar",
    ...
    },
    {
      ...
      to: "/charts/sankey",
      elements: [
        { type: "rect" as const, x: 20, y: 40, width: 32, height: 90, fill: "white", opacity: 0.8, rx: 4 },
        { type: "rect" as const, x: 150, y: 20, width: 32, height: 70, fill: "white", opacity: 0.65, rx: 4 },
        { type: "rect" as const, x: 150, y: 140, width: 32, height: 95, fill: "white", opacity: 0.45, rx: 4 },
        { type: "rect" as const, x: 290, y: 50, width: 32, height: 80, fill: "white", opacity: 0.8, rx: 4 },
        { type: "rect" as const, x: 290, y: 165, width: 32, height: 60, fill: "white", opacity: 0.55, rx: 4 },
      ],
    },
    {
      title: "Dots",
