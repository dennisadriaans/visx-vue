  ...
  const galleryTiles: GalleryTileData[] = [
    ...
    },
    {
      ...
      elements: [
        ...
        { type: "rect" as const, x: 250, y: 130, width: 130, height: 50, fill: neonColor, opacity: 0.3, rx: 6 },
        { type: "rect" as const, x: 20, y: 190, width: 150, height: 90, fill: neonColor, opacity: 0.4, rx: 6 },
        { type: "rect" as const, x: 180, y: 190, width: 200, height: 90, fill: neonColor, opacity: 0.2, rx: 6 },
      ],
    },
    {
      title: "Dots",
