<template>
  ...
  >
    <div ref="parentRef" class="chart-container" style="touch-action: none; cursor: crosshair">
      <svg v-if="width > 0" :width="width" :height="height">
        <LinearGradient id="drag2-stroke" from="#ff614e" to="#ffdc64" />
        ...
        <g>
          ...
          <g v-if="isDragging">
            <rect
              ...
              pointer-events="none"
            />
            <circle :cx="x" :cy="y" r="4" fill="transparent" stroke="white" pointer-events="none" />
          </g>
          <rect
            fill="transparent"
            :width="width"
